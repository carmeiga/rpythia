...
bsm=c(1:600,601:750,801:950,1001:1150,1201:1350) # 1201 to 1350 entries are bsm higgses
#these index have been created to choose not so many weak and top events

dis1=dis1[nobsm,nobsm]
...
pdf(file = "permhist.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 5) # The height of the plot in inches

par(mfrow=c(1,2))
hist(That,xlab='T',ylab='Contas',main='Histograma de T')
abline(v=Thatest,col="red")
abline(v=thatbsm,col="green")

hist(M,xlim=c(0.40,0.60),xlab='M',ylab='Contas',main='Histograma de M')
abline(v=Mest,col="red")
abline(v=mestbsm,col="green")

dev.off()
#hist(theta,xlim=c(0.40,0.60))
#abline(v=thetaest,col="red")
#abline(v=thetabsm,col="green")
